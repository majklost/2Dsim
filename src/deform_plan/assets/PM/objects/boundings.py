...
class Boundings(PMMultiBodyObject):
    ...
    def _create_boundings(self):
        ...
        self.append(Rectangle([self.width/2,self.height],self.width,20,self._btype))
        self.append(Rectangle([0,self.height/2],20,self.height,self._btype))
        self.append(Rectangle([self.width,self.height/2],20,self.height,self._btype))